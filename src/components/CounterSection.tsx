...
export default function CounterSection() {
  return (
    <section
      className="number-bg lg:py-12 py-7"
      style={{
      ...
      <div className="container w-full pr-28 pl-28 mr-auto ml-auto">
        <div className="rowCounter items-center">
          ...
          >
            ...
            <div className="none md:block ks-growth-num col-3  col-dark col-dark-2 text-center rounded-br-xl !border-0">
              <img
                alt="earth"
                loading="lazy"
                width="140"
                ...
                srcSet="../assets/Pointers/earth4.gif"
